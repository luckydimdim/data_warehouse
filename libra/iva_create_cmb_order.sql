...
on duplicate key update
  ...
  insert iva_cmb_extra_accruals
    (order_id, type, user_id, value, created, period_id, comment)
  select
    property_2216,
    property_2217,
  ...
  on duplicate key update
    ...
    iva_cmb_extra_accruals.comment = property_2225;


    call largo.iva_create_cmb_order(current_order_id);
